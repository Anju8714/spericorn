...
<button class="chat-btn" id="chat-button" onclick="toggleChat()">
        <img id="chat-button-img" src="" alt="bot" width="40" height="40" >
        <div class="online"></div>
</button>

<div class="chat-box-outer hide" id="chat-window">
    <div class="chat-header">
       <div class="avatar">
          <img src="/img/woman-w.svg" alt="chat avathar" width="32" height="24">
          <div class="online"></div>
          <!-- <div class="online offline"></div> -->
          <!-- <div class="online away"></div> -->
       </div>
       <div class="h-rgt">
          <strong>Kataline</strong>

       </div>

       <button class="btn-close"  aria-label="close" onclick="closeChat()" >
    ...
    <div class="chat-box" id="chat_box">
       ...
       <div class="company-msg msg-otr">
          <div class="otr">
             <div class="chat-avathar av-default"><img src="/img/woman.svg" alt="chat avathar"  width="25" height="25"></div>
             <div class="msg">
                <p>Hi, I’m Kataline. Ask me anything</p>
             </div>
          </div>
       </div>
    </div>
    ...
    <div class="tye-msg">
       <input type="text" id="question_field" class="form-control" placeholder="Start a conversation">
       <button class="send-btn btn-hidden" id="send_button" onclick="socket_call()" disabled="disabled"><img src="/img/send-icon.svg" alt="send">
    </button>
    </div>
    <input type="hidden" id="keep_context_field" value="">
 </div>
